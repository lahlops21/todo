...
const CriarTarefa = (evento) => {
    ...
    evento.preventDefault(); // Impede o comportamento padrão do clique de atualizar do botão
    ...
    // tarefa.appendChild(BotaoConclui()) // Adicione o botão de concluir no li os componentes são chamados e vistos no html através de tags SEMPRE        
